...
class Test(mz.Module):
    def setup(self):
        ...
        notes = mz.ButterworthFilter((note_track1 + note_track2)/3 >> mz.Collect("sum"), f_low=mz.Constant(1), f_high=mz.Constant(1000), mode="bp") >> mz.Collect("filtered")
...
if __name__ == "__main__":
    mz.plot_module(Test, start_frame=0, num_frames=10, cluster=True)
